...
! !----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
! !  2te lattice-SR: wohl nicht für höhere Dichten geeignet
! !----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
!         call random_number(ran)
! 
!         charge_positions(1,chargeid(1)) =  particle_positions(1,ii) + 0.5_rk*dipole_sepa*sigma_list(ii) * sin(ran*PI) * cos(ran*2._rk*PI-PI)
!         charge_positions(2,chargeid(1)) =  particle_positions(2,ii) + 0.5_rk*dipole_sepa*sigma_list(ii) * sin(ran*PI) * sin(ran*2._rk*PI-PI)
!         charge_positions(3,chargeid(1)) =  particle_positions(3,ii) + 0.5_rk*dipole_sepa*sigma_list(ii) * cos(ran*PI)  
!         charge_positions(1,chargeid(2)) =  particle_positions(1,ii) - 0.5_rk*dipole_sepa*sigma_list(ii) * sin(ran*PI) * cos(ran*2._rk*PI-PI)
!         charge_positions(2,chargeid(2)) =  particle_positions(2,ii) - 0.5_rk*dipole_sepa*sigma_list(ii) * sin(ran*PI) * sin(ran*2._rk*PI-PI)
!         charge_positions(3,chargeid(2)) =  particle_positions(3,ii) - 0.5_rk*dipole_sepa*sigma_list(ii) * cos(ran*PI)  
!         
!      end if
!     end do 
!    end if  
